...
import  from "components/Appointment/Show";
...
storiesOf("InterviewerList", module)
  ...
  .add("Initial", () => (
    <InterviewerList interviewers={interviewers} onChange={action("crapBag")} />
  ))
  .add("Preselected", () => (
    <InterviewerList
      interviewers={interviewers}
      value={3}
      onChange={action("Keylicked")}
    />
  ));
...
storiesOf("Appointment", module)
  ...
  .add("Confirm", () => (
    <Confirm
      message="Seriously?"
      onConfirm={action("How dare you?")}
      onCancel={action("Phew")}
    />
  ))
